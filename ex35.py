...
def bear_room():
    ...
    while True:
        ...
        if choice == 'отобрать мед':
            ...
            print('Вы моежете войти в нее. Подразнить медведя или войти в дверь?')
            bear_moved = True
            ...
            print('Введите одно из придложенных действий.')
...
def start():
    ...
    if choice == 'налево':
        ...
        print('Ты ходишь из комнаты в комнату, пока не умираешь с голоду.')
